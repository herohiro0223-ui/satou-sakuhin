      ...
      <main className="pt-14 pb-20 px-4">
        <form onSubmit={handleSubmit} className="space-y-5 py-4">
          ...
          <div>
            ...
            <div className="w-full aspect-square border-2 border-dashed border-cocoa-light rounded-2xl flex flex-col items-center justify-center bg-sand/50 cursor-pointer hover:bg-sand transition-colors">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="48"
                height="48"
